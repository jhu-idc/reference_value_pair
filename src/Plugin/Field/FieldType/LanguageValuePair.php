...
use Drupal\Component\Utility\andom;
...
/**
 * Plugin implementation of the 'language_value_pair' field type.
 * This is the same as a reference_value_pair but limited to using the 
 * Language taxonomy
 *
 * @FieldType(
 *   id = "language_value_pair",
 *   label = @Translation("Language value pair"),
 *   description = @Translation("Stores an Language reference and a value."),
 *   default_widget = "reference_value_select",
 *   default_formatter = "reference_value_formatter",
 *   list_class = "\Drupal\Core\Field\EntityReferenceFieldItemList"
 * )
 */
class LanguageValuePair extends EntityReferenceItem {
  /**
   * {@inheritdoc}
   */
  public static function defaultStorageSettings() {
    return array(
      ...
      // not sure if this next line does anything, but leaving it for now. 
...
/*
  ...
  public function fieldSettingsForm(array $form, FormStateInterface $form_state) {
    ...
    $form['handler'] = array(
      ...
      '#disabled' => TRUE, 
      '#description' => "This Langauge Value Pair will be tied to the Language Taxonomy, as shown below.  " .
          "As this field is specific to Language, <b>this field choice cannot be changed</b>."
    );
